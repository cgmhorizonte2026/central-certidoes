...
const selectors = { cnpj: ['input[name*="cnpj" i]','input[id*="cnpj" i]','input[placeholder*="CNPJ" i]','input[name*="cpfcnpj" i]','input[id*="cpfcnpj" i]','input[maxlength="14"]','input[maxlength="18"]','input.gwt-TextBox.textbox_box'] };
