  ...
  async resolve(company,{force=false}={}){
    ...
    for(const home of official){
      try{
        ...
        const queue=[root,{url:new URL('/servicos.php',root.url).href,html:null},{url:new URL('/cartaservicos.php',root.url).href,html:null}],visited=new Set(),candidates=[],rejections=[];
